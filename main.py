...
if uploaded_file is None:
    ...
    sample_data = {
        ...
        'Market_Cap': [2.86, 4.14, 28.77, 4.61, 2800.5, 2100.3, 420.8, 350.2, 260.4, 410.6,
                      520.3, 265.4, 445.2, 445.8, 290.1, 220.5, 260.8, 130.2, 180.4, 200.5],
        'Current_Ratio': [0.69, 0.70, 3.57, 9.00, 1.15, 2.45, 1.32, 0.95, 1.18, 0.82,
                         1.08, 1.05, 1.12, 1.25, 1.18, 1.45, 1.28, 0.75, 0.68, 1.02],
        'Dividend_Yield': [2.06, 4.06, 3.30, 4.23, 0.52, 0.68, 2.58, 2.41, 3.15, 1.65,
                          2.08, 2.45, 2.68, 5.85, 3.21, 4.12, 2.95, 7.25, 6.58, 1.95],
        'PE_Ratio': [9.73, 5.72, 1.90, 4.44, 28.5, 32.1, 15.8, 24.2, 25.6, 26.8,
        ...
        'Debt_to_Capital': [46.37, 57.79, 24.12, 29.38, 15.2, 18.5, 35.4, 28.9, 42.1, 38.7,
                           25.8, 45.2, 38.9, 25.4, 28.7, 42.8, 35.6, 52.1, 48.9, 32.4],
        'Earnings_Stability': [True, False, True, True, True, True, True, True, True, False,
    ...
    for i in range(50):
        row = {
            ...
            'Current_Ratio': np.random.uniform(0.5, 10),
